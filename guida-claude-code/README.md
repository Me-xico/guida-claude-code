...
stato eseguito davvero, ogni schermata è reale, ogni fatto è controllato
...
React/TS i cui file — `CLAUDE.md`, `.claude/settings.json` — sono mostrati
...
resto — la velocità — arriva da sola con la pratica.
